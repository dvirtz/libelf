[![Travis Build Status](https://travis-ci.org/dvirtz/libelf.svg?branch=cmake)](https://travis-ci.org/dvirtz/libelf)
...
Another configure option, `-Ddebug=ON`, adds debugging code to
